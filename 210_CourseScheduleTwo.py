...
class TestMethods(unittest.TestCase):
    ...
    def test_isMatch_ex1(self):
        ...
        output = [0,1]
        mySolution = Solution()
        self.assertEqual(mySolution.findOrder(2,inputs), output)
        
    def test_isMatch_ex2(self):
        inputs = [[1,0],[2,0],[3,1],[3,2]]
        output = [0,2,1,3]
        mySolution = Solution()
        self.assertEqual(mySolution.findOrder(4,inputs), output)
        
    def test_isMatch_ex3(self):
        inputs = []
        output = [0]
        mySolution = Solution()
        self.assertEqual(mySolution.findOrder(1,inputs), output)
